        ...
        try {
            ...
            while (rs_child_category.next()) {
                ...
                while (rs_child_category_details.next()) {
                    ...
                    while (loop_test) {
                        String SQL_inside_loop_getchild_Category = "select child_category_id from parent_child_category_mappings where parent_category_id='" + outsider_parent_child_cat_id + "' ";
                        System.out.println("SQL_inside_loop_getchild_Category---------------" + SQL_inside_loop_getchild_Category);
                        PreparedStatement pst_inside_loop_child_category = con.prepareStatement(SQL_inside_loop_getchild_Category);
                        ...
                        while (rs_innside_loopchild_category.next()) {
                            ...
                            String SQL_Inside_Loop_video = "select count(*) from youtube_video_category_mapping where category_id='" + outsider_parent_child_cat_id + "'";
                           ...
                           System.out.println("Integer.parseInt(rs_inside_loop_ot_videos.getString(1))--"+Integer.parseInt(rs_inside_loop_ot_videos.getString(1)));
                            total_video_count = total_video_count + Integer.parseInt(rs_inside_loop_ot_videos.getString(1));
