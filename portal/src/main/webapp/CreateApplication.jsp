...
<html>
    ...
    <body>
        <%
          ...
          String bg_img_limit = (String) session.getAttribute("bg_limit");
             
            System.out.println("bg_img_limit in jsp----------"+bg_img_limit);
     
        %>
        <script>
           var limit =<%=bg_img_limit%>;
                   function checksize() {
                var pic = document.getElementById("fileUpload");
             
                if (pic.files[0].size >= (limit *1024)) {
                    alert('Images Size Should Be Less Than  ' +limit+'KB');
                    return false;
                }
                else {
        ...
        <div class="container" style="width:100%;">
            ...
            <div class="breadcrumb flat">
                <a href="login">Home</a>
                <a href="homepageaction" class="active" >Create Application</a>
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 ">
                    <div class="panel panel-primary " style="overflow-y: auto; font-size: 9pt;text-align: center">
                        <div class="panel-heading" >
                            <center>  <h4 class="panel-title">Create New Application</h4></center>
                        </div>
                        <form action="add_application_name"  method="post"  enctype="multipart/form-data">
                                ...
                                <div class="step well" style="">
                                    <table class="table table-striped" style="font-size: 10pt;" height="50%">
                                        <tr class="primary">
                                            ...
                                            <td>
                                                <input type="text" class="form-control input-sm"  name="app_name_1" value="" id="app_name_1" 
                                                       placeholder="Enter Application Name"    required="true" style="width: 100%" />
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="primary">
                                            ...
                                            <td >
                                                <input type="text" class="form-control input-sm"  name="app_status" value="InActive" id="app_status" 
                                                       placeholder="InActive" disabled="true"   required="true" style="width: 100%" />
                                                <input type="hidden" class="form-control input-sm"  name="hidden_app_status" value="InActive" id="hidden_app_status" 
                                                       placeholder="InActive"    required="true" style="width: 100%" />

                                            </td>
                                        </tr>
                                        <tr class="primary">
                                            <td>
                                                <b>Application Background Image*</b>
                                            </td>
                                            <td>
                                                <input type="file" name="fileUpload" id="fileUpload" onchange="checksize();" required="true"/>
                                            </td>
                                        </tr>
