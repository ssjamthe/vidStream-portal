...
<html>
    <head>
        ...
        <title>Application Poperty </title>
        ...
        <script type="text/javascript">
            ...
            <%
                ...
                d = (ArrayList) session.getAttribute("list_all_property");
            ...
            function add_data() {
                ...
                for (var i = 0; i < data_list.length / 2; i++) {
                    ...
                    db.clients1 =
                            {
                                "Property_Name": data_list[j],
                                "Property_Value": data_list[++j],
                            };
                    j++;
            ...
            function add(a) {
                ...
                $("#jsGrid").jsGrid({
                    ...
                    fields: [
                        {name: "Property_Name", type: "text", width: 60,align: "center",title: "Property Name"},
                        {name: "Property_Value", type: "text", width: 60,align: "center",title: "Property Value"},
                        {itemTemplate: function (_, item) {

                                return $("<button>").attr("type", "button").text("Edit").addClass("btn btn-info")
                                        .on("click", function () {

                                            showDetailsDialog(item.Property_Name, item.Property_Value);
                                        })
                            },
                            align: "center",
                            width: 50
                        },
                        {
                            headerTemplate: function () {
                                return $("<button>").attr("type", "button").text("Add New Property").addClass("btn btn-info").removeClass("ui-icon-closethick")
                                        .on("click", function () {
                                          add_tab();
                                        });
                            },
                            itemTemplate: function (_, item) {
                                ...
                                return $("<button>").attr("type", "button").text("Delete").addClass("btn btn-info")
                                        .on("click", function () {
                                           deleted_property(item.Property_Name);
                                        });
                            },
                            align: "center",
                            width: 50
            ...
            function deleted_property(name) {


                $("#dialog_delete").dialog({
                    modal: true,
                    autoOpen: false,
                    title: "Delete Application Propety",
                    width: 300,
                    height: 200

                }).dialog("open");
                $("#hidden_del_prop_name").val(name);



            }

            function showDetailsDialog(propname,propvalue) {

                $("#edit_dialog").dialog({
                    modal: true,
                    autoOpen: false,
                    title: "Edit Application Property",
                    width: 500,
                    height: 250
                }).dialog("open");
                $("#edit_prop_name").val(propname);
                  $("#hidden_edit_prop_name").val(propname);
                
                $("#edit_prop_value").val(propvalue);
    ...
    <body>
        ...
        <div class="breadcrumb flat">
            <a href="login">Home</a>
            <a href="preadd_property" class="active">Application Property</a>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12 ">
                    ...
                    <div id="add_dialog" style="display: none" align = "center">
                        ...
                        <form action="add_property"  method="post">
                            <table class="table table-striped">
                                ...
                                <td><input id="property_name" class="form-control input-sm" name="property_name" type="text" style="width: 100%" required="true"/> </td>
                                </tr>
                                <tr class="info">
                                   
                                    <td> <label> Property Value :</label> </td>
                                <td><input id="property_value" class="form-control input-sm" name="property_value" type="text" style="width: 100%" required="true"/> </td>
                                </tr>
                                <tr class="info">
                        ...
                        <form action="update_app_property" method="post" enctype="multipart/form-data"> 
                            <table class="table table-striped">
                                ...
                                <tr class="info">
                                    <td> <label>Property  Name:</label> </td>
                                    <td>
                                        <input id="edit_prop_name" name="edit_prop_name" class="form-control input-sm" type="text" disabled="true" />
                                         <input id="hidden_edit_prop_name" name="hidden_edit_prop_name" class="form-control input-sm" type="hidden" />
                                    </td>
                                    <td></td>
                                </tr> 
                                ...
                                <tr class="info">
                                    <td> <label>Property Value :</label> </td>
                                    <td>
                                        <input id="edit_prop_value" name="edit_prop_value" class="form-control input-sm" type="text" />
                                    </td>
                                    <td></td>
                                </tr> 
                                <tr class="info">
                    ...
                    <div id="dialog_delete" style="display: none; font-size: 9pt;" align = "center">
                        ...
                        <form action="delete_app_property"  method="post"> 
                            <table class="table table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" name="hidden_del_prop_name" id="hidden_del_prop_name"/>
                                    </td>
                    ...
                    <div class="panel panel-primary" style="overflow-y: auto; font-size: 9pt;">
                        <div class="panel-heading" >
                            <center>  <h4 class="panel-title">Application Property Details</h4></center>
                        </div>
