                                            ...
                                            function getVideoDetails(ids) {
                                                ...
                                                $.ajax({
                                                    ...
                                                    $.each(items, function(index, e) {
                                                    	...
                                                    	var statisticsPresent;
                                                    	if(typeof(e.statistics) != 'undefined')
                                                    	{
                                                        ...
                                                        for (var i = 0; i < VideoId_List.length; i++) {
                                                            if (VideoId_List[i].toString() == e.id.toString()) {
                                                                ...
                                                                {
                                                                    videoList = videoList + '<table><tr bgcolor=red;><td><input disabled=true type="checkbox" id="video_id" name="video_id" value="' + e.id + '" /></td> <td><li class="hyv-video-list-item"><div class="hyv-content-wrapper"><a href  class="hyv-content-link" title="' + e.snippet.title + '"><span class="title">' + e.snippet.title + '</span><span class="stat attribution">View Count:</span><span>' + 'Unknown' + '</span><span class="stat attribution">Published Date:<span>' + e.snippet.publishedAt.substr(0, 10) + '</span><span class="stat attribution">by <span>' + e.snippet.channelTitle + '</span></span></a><span class="stat attribution">Category Name: <span>' + data_result_cat + '</span></span><span class="stat attribution">App Name: <span>' + data_result_appname + '</span></span></div><div class="hyv-thumb-wrapper"><a href="" class="hyv-thumb-link"><span class="hyv-simple-thumb-wrap"><img alt="' + e.snippet.title + '" src="' + e.snippet.thumbnails.default.url + '" width="120" height="90"></span></a><span class="video-time">' + YTDurationToSeconds(e.contentDetails.duration) + '</span></div></li> </td></tr></table>';
                                                        ...
                                                        if (e.id != added) {
                                                            ...
                                                            {
                                                                videoList = videoList + '<table><tr><td><input type="checkbox" disabled=true id="video_id" name="video_id" value="' + e.id + '" /></td> <td><li class="hyv-video-list-item"><div class="hyv-content-wrapper"><a href  class="hyv-content-link" title="' + e.snippet.title + '"><span class="title">' + e.snippet.title + '</span><span class="stat attribution">View Count: &nbsp;&nbsp;' + 'Unknown' + '</span><span class="stat attribution">Published Date: &nbsp;&nbsp;' + e.snippet.publishedAt.substr(0, 10) + '</span><span class="stat attribution">by <span>' + e.snippet.channelTitle + '</span></span></a></div><div class="hyv-thumb-wrapper"><a href="" class="hyv-thumb-link"><span class="hyv-simple-thumb-wrap"><img alt="' + e.snippet.title + '" src="' + e.snippet.thumbnails.default.url + '" width="120" height="90"></span></a><span class="video-time">' + YTDurationToSeconds(e.contentDetails.duration) + '</span></div></li> </td></tr></table>';
