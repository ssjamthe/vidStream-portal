...
<html>
    <head>
        ...
        <title>List All Categorization  </title>
        ...
        <script>
            ...
            <%
                ...
                d = (ArrayList) session.getAttribute("categorization_list");
            ...
            function add_data() {
                ...
                for (var i = 0; i < data_list.length / 7; i++) {
                    ...
                    db.clients1 =
                            {"App_ID": data_list[sy],
                                "Categorization_Name": data_list[k].link("listcategories?cat_name=" + data_list[catzid] + ""),
                                "Categorization_Image": ('<center><img class="circular"  height="70px" width="100px" src="data:image;base64,' + data_list[l] + '" /></center>'),
                                "No_Of_Categories": (data_list[++j]),
                                "No_Of_video": data_list[++j],
            ...
            function add(a) {
                ...
                $("#jsGrid").jsGrid({
                    ...
                    fields: [
                        ...
                        {name: "Categorization_Name", type: "text", width: 90,align: "center",title: "Categorization Name"},
                        {name: "Categorization_Image", type: "text", width: 100,align: "center",title: "Categorization Image"},
                        {name: "No_Of_Categories", type: "text", width: 80,align: "center",title: "No Of Categories"},
                        {name: "No_Of_video", type: "text", width: 50,align: "center",title: "No Of video"},
                        ...
                        {itemTemplate: function(_, item) {
                                ...
                                return $("<button>").attr("type", "button").text("Edit").addClass("btn btn-primary")
                                        .on("click", function() {
                                    EditDetailsCategorization(item.App_ID, item.Categorization_Name, item.Categorization_Image);
                                });
                            },
                            align: "center",
                            width: 50
                        ...
                        {itemTemplate: function(_, item) {
                                ...
                                return $("<button>").attr("type", "button").text("Delete").addClass("btn btn-primary")
                                        .on("click", function() {
                                    deleted_Categorization(item.App_ID, item.Categorization_Name);
                                });
                            },
                            align: "center",
                            width: 50
            ...
            function EditDetailsCategorization(appid, name, img) {

                var catname_edit = name.substring(name.indexOf('</') + 1, name.indexOf('">'));
                var catnamenewedit = catname_edit.substring(catname_edit.indexOf('>') + 1, catname_edit.indexOf('<'));



                $("#dialog_edit_categorization").dialog({
                    modal: true,
                    autoOpen: false,
                ...
                $("#categorization_appid").val(appid);
                $("#hidden_categorization_appid").val(appid);
                $("#edit_categorization_Name").val(catnamenewedit);
                $("#img1").html(img);
                $.ajax({
                    url: "${pageContext.request.contextPath}/getCategorizationServlet?categorization_name=" + catnamenewedit,
                    type: 'POST',
                    dataType: 'json',
                    contentType: 'application/json',
                    mimeType: 'application/json',
                    success: function(data) {
                        categorization_id = data[0].categorization_id.toString();
                        $("#edit_categorization_ID").val(categorization_id);
                        $("#hidden_edit_categorization_ID").val(categorization_id);
                    },
            ...
            function deleted_Categorization(id, name) {
                var catname = name.substring(name.indexOf('</') + 1, name.indexOf('">'));
                var catnamenew = catname.substring(catname.indexOf('>') + 1, catname.indexOf('<'));

                $("#dialog_delete_Categorization").dialog({
                    modal: true,
                    autoOpen: false,
                    title: "Delete Categorization",
                    width: 300,
                    height: 150

                }).dialog("open");
                $("#hidden_app_id").val(id);
                $("#hidden_categorization_name").val(catnamenew);
                $.ajax({
                    url: "${pageContext.request.contextPath}/getCategorizationServlet?categorization_name=" + catnamenew,
                    type: 'POST',
                    dataType: 'json',
                    contentType: 'application/json',
                    mimeType: 'application/json',
                    success: function(data) {
                        categorization_id = data[0].categorization_id.toString();
                        $("#hidden_categorization_id").val(categorization_id);
                    },
                    error: function(data, status, er) {
            ...
            function add_tab_categorization() {
 ...
 <script>
      ...
      function checkEditsize() {
        ...
        <div class="breadcrumb flat">
            <a href="login">Home</a>
            <a href="listcategorization?app_name=<%=app%>" class="active"  ><%=app_name%></a>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12 ">
                    <center>
                        <table style="margin-right:120pt; margin-top: -22px;" >
                            <tr>
                                <td>
                            <p1>
                                <button type = "button" name="button1" id="button1"  class = "btn btn-info" onclick="add_tab_categorization();" >
                                    Create Categorization &nbsp;<span class="glyphicon glyphicon-plus-sign"></span>
                                </button>
                            </p1>
                            </td>
                            </tr>
                    ...
                    <div id="dialog" style="display: none" align = "center">
                        ...
                        <form action="add_categorization"  method="post" enctype="multipart/form-data">
                            <table class="table table-striped">
                                <tr class="info">
                                <input id="app_id" name="app_id" type="hidden" value="<%=app%>"style="width: 100%" required="true"/>

                                <td> <label> Name :</label> </td>
                                <td><input id="categorization" class="form-control input-sm" name="categorization" type="text" style="width: 100%" required="true"/> </td>
                                </tr>
                                <tr class="info">
                                    <td> <label>Image:</label> </td>
                                    <td>
                                        <input class="form-control input-sm" type="file" name="fileUpload" id="fileUpload"  required="true" onchange="checksize();"/>
                                    </td>
                                </tr>
                                <tr class="info">
                                    <td ><button  class="btn btn-info" style="margin-left: 50px;" type="submit" name="submitButton" value="Submit"  onclick="return checksize();" >Submit</button></td>
                    ...
                    <div id="dialog_edit_categorization" style="display: none; font-size: 9pt; " align = "center">
                        <br>

                        <form action="update_categorization" method="post" enctype="multipart/form-data"> 
                            <table class="table table-striped">

                                <tr class="info">
                                    <td> <label>Application ID :</label> </td>
                                    <td>
                                        <input id="categorization_appid" name="categorization_appid" class="form-control input-sm" type="text" disabled="true" />
                                        <input type="hidden" id="hidden_categorization_appid" class="form-control input-sm"  name="hidden_categorization_appid" /> 
                                    </td>
                                    <td></td>
                                </tr> 

                                <tr class="info">
                                    <td> <label>Categorization ID :</label> </td>
                                    <td>
                                        <input id="edit_categorization_ID" name="edit_categorization_ID" class="form-control input-sm" type="text" disabled="true" />
                                        <input type="hidden" id="hidden_edit_categorization_ID" class="form-control input-sm"  name="hidden_edit_categorization_ID" /> 
                                    </td>
                                    <td></td>
                                </tr> 
                                <tr class="info">
                                    <td> <label>Categorization Name :</label> </td>
                                    <td><input id="edit_categorization_Name" name="edit_categorization_Name" class="form-control input-sm" type="text"  required="true"/> </td>
                                    <td></td>
                                </tr>
                                ...
                                <tr class="info">
                                    <td> <label>Categorization Image :</label> </td>
                                    <td>
                    ...
                    <div id="dialog_delete_Categorization" style="display: none; font-size: 9pt;" align = "center">
                        <br>

                        <form action="delete_categorization"  method="post"> 
                            <table class="table table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" name="hidden_categorization_name" id="hidden_categorization_name"/>
                                        <input type="hidden" name="hidden_categorization_id" id="hidden_categorization_id"/>
                                    </td>
                    ...
                    <div class="panel panel-primary" style="overflow-y: auto; font-size: 9pt;">
                        <div class="panel-heading" >
                            <center>  <h4 class="panel-title">Application  Categorization Details</h4></center>
                        </div>
