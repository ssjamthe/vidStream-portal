...
!function (a, b, c) {
    ...
    d.prototype = {width: "auto", height: "auto", updateOnResize: !0, rowClass: b.noop, rowRenderer: null, rowClick: function (a) {
            ...
            var c, d;
            return 1 === arguments.length ? this[a] : (c = {option: a, oldValue: this[a], newValue: b}, this._callEventHandler(this.onOptionChanging, c), this._handleOptionChange(c.option, c.newValue), d = {option: c.option, value: c.newValue}, void this._callEventHandler(this.onOptionChanged, d))
            ...
            this._clear(), this._container.addClass(this.containerClass).css("position", "relative").append(this._createHeader()).append(this._createBody()), this._pagerContainer = this._createPagerContainer(), this._loadIndicator = this._createLoadIndicator(), this.refresh()
        }, _createLoadIndicator: function () {
            return t(this.loadIndicator, this, {message: this.loadMessage, shading: this.loadShading, container: this._container})
        }, _clear: function () {
            ...
            if (b.isFunction(this.headerRowRenderer))
                return b(this.headerRowRenderer());
            ...
            if (b.isFunction(this.filterRowRenderer))
                return b(this.filterRowRenderer());
            ...
            if (b.isFunction(this.insertRowRenderer))
                return b(this.insertRowRenderer());
            ...
            var a = t(this.noDataContent, this), c = 0;
            ...
            return d = b.isFunction(c.cellRenderer) ? b(c.cellRenderer(e, a)) : b("<td>").append(c.itemTemplate ? c.itemTemplate(e, a) : e), d.addClass(c.css).width(c.width), c.align && d.addClass("jsgrid-align-" + c.align), d
        }, _getItemFieldValue: function (a, b) {
            for (var c = b.name.split("."), d = a[c.shift()]; d && c.length; )
                d = d[c.shift()];
            return d
        }, _setItemFieldValue: function (a, b, c) {
            for (var d = b.name.split("."), e = a, f = d[0]; e && d.length > 1; )
                a = e, f = d.shift(), e = a[f];
            if (!e)
                for (; d.length; )
                    a = a[f] = {}, f = d.shift();
            ...
            var a;
            return a = b.isFunction(this.pagerRenderer) ? b(this.pagerRenderer({pageIndex: this.pageIndex, pageCount: this._pagesCount()})) : b("<div>").append(this._createPagerByFormat()), a.addClass(this.pagerClass), a
            ...
            var a, b = this._pagesCount(), c = this.pageButtonCount, d = this._firstDisplayingPage, e = [];
            d > 1 && e.push(this._createPagerPageNavButton(this.pageNavigatorPrevText, this.showPrevPages));
            for (var f = 0, a = d; c > f && b >= a; f++, a++)
                e.push(a === this.pageIndex ? this._createPagerCurrentPage() : this._createPagerPage(a));
            return b > d + c - 1 && e.push(this._createPagerPageNavButton(this.pageNavigatorNextText, this.showNextPages)), e
            ...
            if (!f || !f[a])
                throw new Error("controller has no method '" + a + "'");
            ...
            var b = a || this._getInsertItem(), c = this._callEventHandler(this.onItemInserting, {item: b});
            return this._controllerCall("insertItem", b, c.cancel, function (a) {
                a = a || b, this._loadStrategy.finishInsert(a), this._callEventHandler(this.onItemInserted, {item: a})
            })
            ...
            if (this.editing) {
                ...
                var b = a.data(g), c = this._createEditRow(b);
                this._editingRow = a, a.hide(), c.insertAfter(a), a.data(h, c)
            }
        }, _createEditRow: function (a) {
            if (b.isFunction(this.editRowRenderer))
                return b(this.editRowRenderer(a, this._itemIndex(a)));
            var c = b("<tr>").addClass(this.editRowClass);
            return this._eachField(function (d) {
                var e = this._getItemFieldValue(a, d);
                b("<td>").addClass(d.editcss || d.css).appendTo(c).append(d.editTemplate ? d.editTemplate(e, a) : "").width(d.width || "auto")
            }), c
        }, updateItem: function (a, b) {
            1 === arguments.length && (b = a);
            var c = a ? this.rowByItem(a) : this._editingRow;
            return b = b || this._getEditedItem(), this._updateRow(c, b)
            ...
            if (this._editingRow) {
                var a = this._editingRow, b = a.data(h);
                b.remove(), a.show(), this._editingRow = null
            }
            ...
            var b = a.data(g), c = this._itemIndex(b), d = this._callEventHandler(this.onItemDeleting, {row: a, item: b, itemIndex: c});
            return this._controllerCall("deleteItem", b, d.cancel, function () {
                this._loadStrategy.finishDelete(b, c), this._callEventHandler(this.onItemDeleted, {row: a, item: b, itemIndex: c})
            })
    ...
    a.jsGrid = {Grid: d, fields: v, setDefaults: w}
}(window, jQuery), function (a, b) {
    function c(a) {
        this._init(a)
    }
    c.prototype = {container: "body", message: "Loading...", shading: !0, zIndex: 1e3, shaderClass: "jsgrid-load-shader", loadPanelClass: "jsgrid-load-panel", _init: function (a) {
            b.extend(!0, this, a), this._initContainer(), this._initShader(), this._initLoadPanel()
        }, _initContainer: function () {
            this._container = b(this.container)
        }, _initShader: function () {
            this.shading && (this._shader = b("<div>").addClass(this.shaderClass).hide().css({position: "absolute", top: 0, right: 0, bottom: 0, left: 0, zIndex: this.zIndex}).appendTo(this._container))
        }, _initLoadPanel: function () {
            this._loadPanel = b("<div>").addClass(this.loadPanelClass).text(this.message).hide().css({position: "absolute", top: "50%", left: "50%", zIndex: this.zIndex}).appendTo(this._container)
        }, show: function () {
    ...
    c.prototype = {firstDisplayIndex: function () {
            var a = this._grid;
        ...
        }}, d.prototype = {firstDisplayIndex: function () {
            return 0
        }, lastDisplayIndex: function () {
            return this._grid.option("data").length
        }, itemsCount: function () {
    ...
    d.prototype = {name: "", title: null, css: "", align: "", width: 100, visible: !0, filtering: !0, inserting: !0, editing: !0, sorting: !0, sorter: "string", headerTemplate: function () {
    ...
    var d = a.Field;
    c.prototype = new d({autosearch: !0, filterTemplate: function () {
            if (!this.filtering)
                return"";
    ...
    var d = a.TextField;
    c.prototype = new d({sorter: "number", align: "right", filterValue: function () {
    ...
    var d = a.TextField;
    c.prototype = new d({insertTemplate: function () {
            if (!this.inserting)
                return"";
    ...
    var e = a.NumberField;
    d.prototype = new e({align: "center", valueType: "number", itemTemplate: function (a) {
    ...
    var e = a.Field;
    d.prototype = new e({sorter: "number", align: "center", autosearch: !0, itemTemplate: function (a) {
    ...
    c.prototype = new d({css: "jsgrid-control-field", align: "center", width: 50, filtering: !1, inserting: !1, editing: !1, sorting: !1, buttonClass: "jsgrid-button", modeButtonClass: "jsgrid-mode-button", modeOnButtonClass: "jsgrid-mode-on-button", searchModeButtonClass: "jsgrid-search-mode-button", insertModeButtonClass: "jsgrid-insert-mode-button", editButtonClass: "jsgrid-edit-button", deleteButtonClass: "jsgrid-delete-button", searchButtonClass: "jsgrid-search-button", clearFilterButtonClass: "jsgrid-clear-filter-button", insertButtonClass: "jsgrid-insert-button", updateButtonClass: "jsgrid-update-button", cancelEditButtonClass: "jsgrid-cancel-edit-button", searchModeButtonTooltip: "Switch to searching", insertModeButtonTooltip: "Switch to inserting", editButtonTooltip: "Edit", deleteButtonTooltip: "Delete", searchButtonTooltip: "Search", clearFilterButtonTooltip: "Clear filter", insertButtonTooltip: "Insert", updateButtonTooltip: "Update", cancelEditButtonTooltip: "Cancel edit", editButton: !0, deleteButton: !0, clearFilterButton: !0, modeSwitchButton: !0, _initConfig: function () {
            ...
            var e = this._grid;
            return b("<input>").addClass(this.buttonClass).addClass(a).attr({type: "button", title: c}).on("click", function (a) {
                d(e, a)
            })
        }, editValue: function () {
            return""
